...
def show_page():
    ...
    st.markdown(r'''   $r_{nk} = \begin{cases} 1 & \mathrm{if } k = \argmin_j ||x_n - \mu_j||^2 \\ 0 & \mathrm{otherwise} \end{cases} $''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$p({x_n} | \pi, \mu, \Sigma) = \prod_{n=1}^N p(x_n | \pi, \mu, \Sigma)$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\ln p({x_n} | \pi, \mu, \Sigma) = \sum_{n=1}^N \ln\bigg(\sum_{k=1}^K \pi_k \mathcal{N}(x_n | \mu_k, \Sigma_k)\bigg)$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$0 = -\sum_{n=1}^N \frac{\pi_k \mathcal{N}(x_n | \mu_k, \Sigma_k)}{\sum_j \pi_j \mathcal{N}(x_n | \mu_j, \Sigma_j)} * \Sigma_k^{-1} (x_n - \mu_k)$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\gamma_{nk} = \frac{\pi_k \mathcal{N}(x_n | \mu_k, \Sigma_k)}{\sum_j \pi_j \mathcal{N}(x_n | \mu_j, \Sigma_j)}$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\mu_k = \frac{\sum_{n=1}^N \gamma_{nk}x_n}{\sum_{n=1}^N \gamma_{nk}}$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\Sigma_k = \frac{\sum_{n=1}^N \gamma_{nk}(x_n - \mu_k)(x_n - \mu_k)^T}{\sum_{n=1}^N \gamma_{nk}}$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\dfrac{\partial L}{\partial \pi_k} = \sum_n \dfrac{1}{p(x_n)} * \mathcal{N}(x_n | \mu_k, \Sigma_k) - \lambda = 0$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\sum_k \pi_k * \sum_n \dfrac{1}{p(x_n)} * \mathcal{N}(x_n | \mu_k, \Sigma_k) - \lambda\sum_k \pi_k = 0$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''$\pi_k * \sum_n \dfrac{1}{p(x_n)} * \mathcal{N}(x_n | \mu_k, \Sigma_k) = N\pi_k$''')
    st.markdown(r'''''')
    st.markdown(r'''Rearranging, we arrive at the update rule for $\pi_k$:''')
    st.markdown(r'''''')
    st.markdown(r'''$\pi_k = \dfrac{1}{N} * \sum_n \gamma_{nk}$''')
    st.markdown(r'''''')
    ...
    st.markdown(r'''''')
    st.markdown(r'''   $\mu_k = \frac{\sum_n \gamma_{nk}x_n}{\sum_n \gamma_{nk}}$''')
    st.markdown(r'''   ''')
    st.markdown(r'''   $\Sigma_k = \frac{\sum_n \gamma_{nk}(x_n - \mu_k)(x_n - \mu_k)^T}{\sum_n \gamma_{nk}}$''')
    st.markdown(r'''   ''')
    st.markdown(r'''   $\pi_k = \dfrac{1}{N} \sum_n \gamma_{nk}$''')
    st.markdown(r'''''')
