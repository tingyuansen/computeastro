...
def navigation_menu():
    ...
    st.sidebar.page_link("pages/lecture_1_linear_regression.py", label="Lecture")
    st.sidebar.page_link("pages/tutorial_1_linear_regression.py", label="Tutorial")
    st.sidebar.markdown("Ch. 2: Logistic Regression")
    st.sidebar.page_link("pages/lecture_2_logistic_regression.py", label="Lecture")
    ...
    st.sidebar.page_link("pages/lecture_3_clustering.py", label="Lecture")
    ...
    st.sidebar.page_link("pages/lecture_4_pca.py", label="Lecture")
    st.sidebar.page_link("pages/tutorial_4_pca.py", label="Tutorial")
    st.sidebar.markdown("Ch. 5: Neural Network Supervised")
    st.sidebar.page_link("pages/lecture_5_neural_network_supervised.py", label="Lecture")
    ...
    st.sidebar.page_link("pages/lecture_6_neural_network_unsupervised.py", label="Lecture")
    ...
    st.sidebar.page_link("pages/lecture_7_gaussian_process_regression.py", label="Lecture")
    ...
    st.sidebar.page_link("pages/lecture_8_gaussian_process_classification.py", label="Lecture")
    st.sidebar.page_link("pages/tutorial_8_gaussian_process_classification.py", label="Tutorial")
    st.sidebar.markdown("Ch. 9: Sampling")
    st.sidebar.page_link("pages/lecture_9_sampling.py", label="Lecture")
