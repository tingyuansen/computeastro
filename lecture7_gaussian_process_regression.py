...
def show_page():
    ...
    ''')
    video_embed_code = """
        <iframe width="700" height="394" src="https://www.youtube.com/watch?v=N6dtX6HlhRc?rel=0&modestbranding=1&autohide=1&showinfo=0&controls=0" frameborder="0" allowfullscreen style="border:none; max-width: 100%;"></iframe>
    """
